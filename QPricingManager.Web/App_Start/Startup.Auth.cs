...
using Owin;
using QPricingManager.Web.Models;
...
namespace QPricingManager.Web
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = "754517188337-rvjcohemfub2jkb6jqvm7qou61s02aa1.apps.googleusercontent.com",
                ClientSecret = "r1dYnzaoDnC6uhLr5qikectS"
            });
        }
    }
}